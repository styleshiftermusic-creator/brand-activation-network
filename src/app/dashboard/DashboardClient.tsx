...
const MetricChart = dynamic(
    () => import("@/components/dashboard/MetricChart").then((mod) => mod.MetricChart),
    {
        ssr: false,
        loading: () => <div className="mb-8 h-80 w-full bg-black/40 border border-white/5 rounded-xl animate-pulse flex items-center justify-center text-zinc-500 font-mono text-xs">LOADING TELEMETRY ENGINE...</div>
    }
);
                ...
                <div className="sticky top-10 space-y-6">
                    ...
                    <div className="bg-black/40 backdrop-blur-2xl border border-emerald-500/20 rounded-2xl p-6 relative overflow-hidden group hover:border-emerald-500/40 transition-colors duration-500">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-base font-semibold text-white tracking-tight mb-1">Refer &amp; Earn 30%</h3>
                            <p className="text-xs text-zinc-500 leading-relaxed mb-4">
                                Share your unique link. You earn a 30% commission ($149) for every member who joins through your link.
                            </p>
